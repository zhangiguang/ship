...
def resnet_base(img_batch, scope_name, is_training=True):
    ...
    return C4
def atrous_conv(input, filter):
    c41 = tf.nn.atrous_conv2d(input, filter, 2, 'SAME')
    c42 = tf.nn.atrous_conv2d(c41, filter, 2, 'SAME')
    c43 = tf.nn.atrous_conv2d(c42, filter, 2, 'SAME')
    # c44 = tf.nn.atrous_conv2d(c43, filter, 2, 'SAME')
    # c45 = tf.nn.atrous_conv2d(c44, filter, 2, 'SAME')
    # c46 = tf.nn.atrous_conv2d(c45, filter, 2, 'SAME')
    # c47 = tf.nn.atrous_conv2d(c46, filter, 2, 'SAME')
    #
    # c48 = tf.nn.atrous_conv2d(c47, filter, 2, 'SAME')
    # c49 = tf.nn.atrous_conv2d(c48, filter, 2, 'SAME')
    # c410 = tf.nn.atrous_conv2d(c49, filter, 2, 'SAME')
    # c411 = tf.nn.atrous_conv2d(c410, filter, 2, 'SAME')
    # c412 = tf.nn.atrous_conv2d(c411, filter, 2, 'SAME')
    # c413 = tf.nn.atrous_conv2d(c412, filter, 2, 'SAME')
    # c414 = tf.nn.atrous_conv2d(c413, filter, 2, 'SAME')
    # c415 = tf.nn.atrous_conv2d(c414, filter, 2, 'SAME')
    return c43
