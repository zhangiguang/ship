...
tf.app.flags.DEFINE_string('VOC_dir', '/media/iguang/0004B05B000AB2F6/DOTA/', 'Voc dir')
tf.app.flags.DEFINE_string('xml_dir', 'xml_patch', 'xml dir')
tf.app.flags.DEFINE_string('image_dir', 'img_patch', 'image dir')
