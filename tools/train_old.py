...
def train():
    ...
    with slim.arg_scope([slim.conv2d, slim.conv2d_in_plane,
        ...
        final_boxes_r, final_scores_r, final_category_r, loss_dict, feature = faster_rcnn.build_whole_detection_network(
    ...
    fastrcnn_cls_loss_hh = loss_dict['fastrcnn_cls_loss_hh']
    fastrcnn_loc_loss_hh = loss_dict['fastrcnn_loc_loss_hh']
    fastrcnn_cls_loss_rr = loss_dict['fastrcnn_cls_loss_rr']
    fastrcnn_loc_loss_rr = loss_dict['fastrcnn_loc_loss_rr']
    fastrcnn_total_loss = fastrcnn_cls_loss_h + fastrcnn_loc_loss_h +fastrcnn_cls_loss_r + fastrcnn_loc_loss_r +\
                          fastrcnn_cls_loss_hh + fastrcnn_loc_loss_hh + fastrcnn_cls_loss_rr + fastrcnn_loc_loss_rr
        ...
        for step in range(cfgs.MAX_ITERATION):
            ...
            if step % cfgs.SHOW_TRAIN_INFO_INTE != 0 and step % cfgs.SMRY_ITER != 0:
                ...
                if step % cfgs.SHOW_TRAIN_INFO_INTE == 0 and step % cfgs.SMRY_ITER != 0:
                    ...
                    _feature,_global_step, _img_name_batch, _rpn_location_loss, _rpn_classification_loss, \
                    ...
                    _fast_rcnn_total_loss, _total_loss, _ = \
                        sess.run([feature, global_step, img_name_batch, rpn_location_loss, rpn_cls_loss,
                    ...
                    print(""" {}: step{}    image_name:{} |\t
                          ...
                          .format(training_time, _global_step, str(_img_name_batch[0]), _rpn_location_loss,
                                  ...
                                  (end - start)))
                    for i in range(_feature.shape[3]):
                        _feature1 = _feature[0, :,:, i]
                    # _feature2 = _feature[0,:,:,4:5]
                    # _feature3 = _feature[0,:,:,5:6]
                    #_featurergb = np.concatenate([_feature1, _feature2, _feature3], axis=2)
                        cv2.imwrite('/media/iguang/23a6d0dc-b99b-49a8-9ea9-c857f767ba3a/ship/R2CNN_Faster-RCNN_Tensorflow-master/output/feature/' +
                                  str(i) + '.jpg' , np.float32(_feature1)*256)
                    #exit()
                else:
